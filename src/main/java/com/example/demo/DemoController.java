...
public class DemoController {
	...
	static class DemoControllerRuntimeHints implements RuntimeHintsRegistrar {
		...
		private static final Consumer<Builder> INVOKE = (hint) -> hint.setModes(ExecutableMode.INVOKE);

		@Override
		public void registerHints(RuntimeHints hints, ClassLoader classLoader) {
			hints.reflection()
					.registerConstructor(SimpleHelloService.class.getConstructors()[0], INVOKE)
					.registerMethod(ReflectionUtils.findMethod(
							SimpleHelloService.class, "sayHello", String.class), INVOKE);
		}
